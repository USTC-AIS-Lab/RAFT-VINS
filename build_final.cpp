...
bool MyBuild(const string &onnx_path, const string &tensorrt_path, const int& flag) {
    ...
    if (flag == 0) {
        ...
        profile_0->setDimensions("corr", nvinfer1::OptProfileSelector::kMIN, nvinfer1::Dims4(1, 162, 10, 20));
        profile_0->setDimensions("corr", nvinfer1::OptProfileSelector::kOPT, nvinfer1::Dims4(1, 162, 60, 80));
        profile_0->setDimensions("corr", nvinfer1::OptProfileSelector::kMAX, nvinfer1::Dims4(1, 162, 100, 200));
...
int main (int argc, char** argv) {
    MyBuild("/home/zj/workspace/paper_final/RAFT_CPP_v10/onnx_models/final/final_fnet.onnx", \
                "/home/zj/workspace/paper_final/RAFT_CPP_v10/onnx_models/final/final_fnet.engine", 0);
    MyBuild("/home/zj/workspace/paper_final/RAFT_CPP_v10/onnx_models/final/final_cnet.onnx", \
                "/home/zj/workspace/paper_final/RAFT_CPP_v10/onnx_models/final/final_cnet.engine", 1);
    MyBuild("/home/zj/workspace/paper_final/RAFT_CPP_v10/onnx_models/final/final_update.onnx", \
                "/home/zj/workspace/paper_final/RAFT_CPP_v10/onnx_models/final/final_update.engine", 2);
}
