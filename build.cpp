...
bool MyBuild(const string &onnx_path, const string &tensorrt_path, const int& flag) {
    ...
    if (flag == 0) {
        ...
        profile_0->setDimensions("img0", nvinfer1::OptProfileSelector::kMAX, nvinfer1::Dims4{1, 3, 800, 1400});
        ...
        profile_0->setDimensions("img1", nvinfer1::OptProfileSelector::kMAX, nvinfer1::Dims4{1, 3, 800, 1400});
        ...
        auto profile_0 = builder->createOptimizationProfile();
        profile_0->setDimensions("inp", nvinfer1::OptProfileSelector::kMIN, nvinfer1::Dims4(1, 128, 10, 20));
        profile_0->setDimensions("inp", nvinfer1::OptProfileSelector::kOPT, nvinfer1::Dims4(1, 128, 60, 80));
        profile_0->setDimensions("inp", nvinfer1::OptProfileSelector::kMAX, nvinfer1::Dims4(1, 128, 100, 200));
        profile_0->setDimensions("corr", nvinfer1::OptProfileSelector::kMIN, nvinfer1::Dims4(1, 324, 10, 20));
        profile_0->setDimensions("corr", nvinfer1::OptProfileSelector::kOPT, nvinfer1::Dims4(1, 324, 60, 80));
        profile_0->setDimensions("corr", nvinfer1::OptProfileSelector::kMAX, nvinfer1::Dims4(1, 324, 100, 200));
        profile_0->setDimensions("flow_inp", nvinfer1::OptProfileSelector::kMIN, nvinfer1::Dims4(1, 2, 10, 20));
        profile_0->setDimensions("flow_inp", nvinfer1::OptProfileSelector::kOPT, nvinfer1::Dims4(1, 2, 60, 80));
        profile_0->setDimensions("flow_inp", nvinfer1::OptProfileSelector::kMAX, nvinfer1::Dims4(1, 2, 100, 200));
        config->addOptimizationProfile(profile_0);
        cout << "input shape: " << network->getInput(0)->getName() << " " << network->getInput(0)->getDimensions() << endl;
        cout << "input shape: " << network->getInput(1)->getName() << " " << network->getInput(1)->getDimensions() << endl;
...
int main (int argc, char** argv) {
    MyBuild("/home/zj/workspace/RAFT_CPP/RAFT_CPP_v6/onnx_models/dynamic_fnet.onnx", \
                "/home/zj/workspace/RAFT_CPP/RAFT_CPP_v6/onnx_models/dynamic_fnet.engine", 0);
    MyBuild("/home/zj/workspace/RAFT_CPP/RAFT_CPP_v6/onnx_models/dynamic_cnet.onnx", \
                "/home/zj/workspace/RAFT_CPP/RAFT_CPP_v6/onnx_models/dynamic_cnet.engine", 1);
    MyBuild("/home/zj/workspace/RAFT_CPP/RAFT_CPP_v6/onnx_models/dynamic_decoder.onnx", \
                "/home/zj/workspace/RAFT_CPP/RAFT_CPP_v6/onnx_models/dynamic_decoder.engine", 2);
}
